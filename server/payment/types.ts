...
export type PaymentAdapter = {
  create(input: { orderNo: string; queryToken: string; amount: number; subject: string; notifyUrl: string; returnUrl: string; channel?: PaymentChannel }): Promise<{ mode: "redirect" | "qr"; url?: string; qrCode?: string; paymentOrderNo?: string }>;
