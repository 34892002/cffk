...
const providers = ref<Provider[]>([]); const logs = ref<PaymentLog[]>([]); const draftLogProvider = ref<"ALL" | PaymentProviderKind>("ALL"); const logProvider = ref<"ALL" | PaymentProviderKind>("ALL"); const logPage = ref(1); const logPageSize = ref(20); const logTotal = ref(0); const loading = ref(false);
