...
const initialPolicies: Policy[] = [
  ...
  { messageType: "NORMAL", scene: "PAYMENT_EXCEPTION", channels: [], isEnabled: false }, { messageType: "ADMIN", scene: "PAYMENT_EXCEPTION", channels: ["EMAIL"], isEnabled: true },
];
